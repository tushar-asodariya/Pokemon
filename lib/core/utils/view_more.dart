...
class ViewMore extends StatefulWidget {
  const ViewMore(
    ...
    this.trimExpandedText = 'view less',
    this.trimCollapsedText = 'view more',
    this.colorClickableText,
    this.trimLength = 240,
    this.trimLines = 2,
    this.trimMode = Trimer.length,
    this.style,
    this.textAlign,
    this.textDirection,
    this.locale,
  ...
  @override
  ViewMoreState createState() => ViewMoreState();
}
